        ...
        <>
            ...
            {showSchedule && (
                <div className="calendar__right">
                    <p>August 23, 2023</p>
                    <div
                        className="calendar__right-choose"
                        onMouseEnter={() => setConfirmLesson(true)}
                        onMouseLeave={() => setConfirmLesson(false)}
                    >
                        {confirmLesson ? (
                            <div className="calendar__right-choose-button">
                                <ButtonLinkTransparent text="9:30 PM" />
                                <ButtonLinkTransparent text="Confirm Lesson" />
                            </div>
                        ) : (
                            <ButtonLinkTransparent text="9:30 PM" />
                        )}
