...
import StudentPublicProfilePage from "./pages/StudentPublicProfilePage/StudentPublicProfilePage"
            ...
            <BrowserRouter>
                <Routes>
                    <Route element={<LoggedInInterface />}>
                        ...
                        <Route path="/student/public" element={<StudentPublicProfilePage />} />
                    </Route>
